...
from app.domain.repositories.profile_interest_repository import (
...
class ProfileInterestRepositoryImpl(ProfileInterestRepository):
    ...
    def remove_interests_from_profile(
        self, profile_id: UUID, interest_ids: list[UUID]
    ) -> None:
    ...
    def get_profile_interests(self, profile_id: UUID) -> list[InterestEntity]:
        results = (
            ...
            .join(
                ...
                ProfileInterestModel.interest_id == InterestModel.id,
            )
